...
pg.connect(process.env.DATABASE_URL, function(err, client) {
  ...
  console.log(2222);
  client.query("INSERT INTO salejung.item(shopname, title, pre_price, post_price, detail, latitude, longitude) VALUES ('세일중', '테스트입니다', 12345, 12345, '테스트', 23.2342334, -23.23523523);"
  , function (err, result) {
      if (err) {
